export const PapperSet = (action) => {
  ...
  const Obj = {
    ...
    paperMargin: {
      top: [action.payload.marginTop, action.payload.satuanTop],
      left: [action.payload.marginLeft, action.payload.satuanLeft],
      right: [action.payload.marginRight, action.payload.satuanRight],
      bottom: [action.payload.marginBottom, action.payload.satuanBottom],
    },
    width: width,
    height: height,
  };
